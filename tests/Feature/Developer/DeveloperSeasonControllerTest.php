...
describe('index', function () {
    test('page loads', function () {
        ...
        $response = $this->get(route('developer.seasons.index'));

        // assert successful response
        $response->assertOk();

        // assert view is returned
        $response->assertViewIs('developer.seasons.index');
    ...
    test('seasons can be filtered by sport', function () {
        ...
        $response = $this->get(route('developer.seasons.index', ['sport' => 'Basketball']));
    ...
    test('seasons can be filtered by q for name', function () {
        ...
        // get the season
        $response = $this->get(route('developer.seasons.index', ['q' => $q]));
...
describe('creating a season', function () {
    test('shows create form', function () {
        ...
        // assert view is returned
        $response->assertViewIs('developer.seasons.create');
    ...
    test('flashes success message on store', function () {
        ...
        // post the season data
        $this->post(route('developer.seasons.store'), $seasonData)->assertRedirect();
...
describe('viewing a season', function () {
    ...
    test('shows import games action', function () {
        // create a season
        $season = Season::factory()->create();
...
describe('updating season', function () {
    test('shows edit form', function () {
        ...
        // visit the edit page
        $response = $this->get(route('developer.seasons.edit', $season));

        // assert successful response
        $response->assertOk();

        // assert view is returned
        $response->assertViewIs('developer.seasons.edit');
    ...
    test('flashes success message on update', function () {
        ...
        // patch the season data
        $this->patch(route('developer.seasons.update', $season), $updateData)->assertRedirect();
...
describe('deleting a season', function () {
    test('works', function () {
        ...
        // delete the season
        $response = $this->delete(route('developer.seasons.destroy', $season));
    ...
    test('flashes success message on delete', function () {
        ...
        // delete the season
        $this->delete(route('developer.seasons.destroy', $season))->assertRedirect();
...
describe('importing season games', function () {
    test('shows import form', function () {
        ...
        $response = $this->get(route('developer.seasons.import-games', $season));
