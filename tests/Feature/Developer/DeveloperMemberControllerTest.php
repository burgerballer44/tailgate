...
describe('index', function () {
    test('works', function () {
        ...
        $response = $this->get(route('developer.groups.members.index', $group));

        // assert successful response
        $response->assertOk();

        // assert view is returned
        $response->assertViewIs('developer.members.index');
...
describe('creating a member', function () {
    test('shows create form', function () {
        ...
        $response = $this->get(route('developer.groups.members.create', $group));

        // assert successful response
        $response->assertOk();

        // assert view is returned
        $response->assertViewIs('developer.members.create');
    ...
    test('works', function () {
        ...
        $response = $this->post(route('developer.groups.members.store', $group), $memberData);
    ...
    test('flashes success message on store', function () {
        ...
        // post the member data
        $this->post(route('developer.groups.members.store', $group), $memberData)->assertRedirect();
...
describe('viewing a member', function () {
    test('works', function () {
        ...
        // visit the show page
        $response = $this->get(route('developer.groups.members.show', [$group, $member]));

        // assert successful response
        $response->assertOk();

        // assert view is returned
        $response->assertViewIs('developer.members.show');
...
describe('updating member', function () {
    test('shows edit form', function () {
        ...
        // visit the edit page
        $response = $this->get(route('developer.groups.members.edit', [$group, $member]));

        // assert successful response
        $response->assertOk();

        // assert view is returned
        $response->assertViewIs('developer.members.edit');
    ...
    test('updates a member', function () {
        ...
        $response = $this->patch(route('developer.groups.members.update', [$group, $member]), $updateData);
        ...
        expect($member->status)->toBe($updateData['status']);
    });
    ...
    test('flashes success message on update', function () {
        ...
        // patch the member data
        $this->patch(route('developer.groups.members.update', [$group, $member]), $updateData)->assertRedirect();
...
describe('deleting a member', function () {
    test('works', function () {
        ...
        // delete the member
        $response = $this->delete(route('developer.groups.members.destroy', [$group, $member]));
