...
/**
 * Defines the prediction policy evaluation contract.
 * Implementations evaluate prediction submissions, expose available rules,
 * and resolve the currently enabled group-level policies.
 */
