 ...
 * label, the count of successfully imported records, and any errors encountered.
 *
 ...
 * @param int $importedCount The number of records successfully imported.
...
readonly class ImportResult
{
    ...
    /**
     * Returns true when at least one record was successfully imported.
     */
