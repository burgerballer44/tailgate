...
class PlayerController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->middleware(PlayerMustBelongToMember::class)
            ->only('update', 'destroy', 'submitScore', 'updateScore', 'destroyScore');
        $this->middleware(ScoreMustBelongToPlayer::class)->only('updateScore', 'destroyScore');
    }
