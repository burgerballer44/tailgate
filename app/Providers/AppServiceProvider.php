...
use App\Services\GroupSeasonLeaderboardService;
...
use App\Services\PredictionScoringPolicyCatalogService;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function register(): void
    {
        ...
        $this->app->bind(GroupSeasonLeaderboardServiceInterface::class, GroupSeasonLeaderboardService::class);
        $this->app->bind(PredictionPolicyEvaluatorInterface::class, PredictionPolicyEvaluatorService::class);
        $this->app->bind(PredictionScoringPolicyCatalogInterface::class, PredictionScoringPolicyCatalogService::class);
